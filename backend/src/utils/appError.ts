...
export class AppError extends Error {
    ...
    constructor (message: string, statusCode = HTTPSTATUS.INTERNAL_SERVER_ERROR, errorCode: ErrorCodeEnumType = 'INTERNAL_SERVER_ERROR'){
        super(message);
...
export class HttpException extends AppError {
    constructor(message: string = "HTTP Exception Error", statusCode : HTTPStatusCodeType, errorCode: ErrorCodeEnumType) {
...
export class BadRequestException extends AppError {
    constructor(message: string = "Bad Request", errorCode: ErrorCodeEnumType = ErrorCodeEnum.VALIDATION_ERROR) {
